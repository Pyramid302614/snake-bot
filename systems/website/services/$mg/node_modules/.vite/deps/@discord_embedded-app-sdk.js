...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/_virtual/_commonjsHelpers.mjs
var commonjsGlobal = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : {};
function getDefaultExportFromCjs(x) {
	return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, "default") ? x["default"] : x;
}
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/_virtual/index4.mjs
var eventemitter3 = { exports: {} };
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/lib/eventemitter3/index2.mjs
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/_virtual/index.mjs
var EventEmitter = /* @__PURE__ */ getDefaultExportFromCjs(requireEventemitter3());
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/lib/zod/lib/index.mjs
var util;
(function(util) {
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/_virtual/BigInteger2.mjs
var BigInteger = { exports: {} };
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/lib/big-integer/BigInteger.mjs
	...
	(function(module) {
		var bigInt = (function(undefined$1) {
			...
			function multiplyLong(a, b) {
				var a_l = a.length, b_l = b.length, r = createArray(a_l + b_l), base = BASE, product, carry, i, a_i, b_j;
				for (i = 0; i < a_l; ++i) {
					a_i = a[i];
					for (var j = 0; j < b_l; ++j) {
						b_j = b[j];
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/_virtual/BigInteger.mjs
var bigInt = /* @__PURE__ */ getDefaultExportFromCjs(requireBigInteger());
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/BigFlagUtils.mjs
/**
...
function splitBigInt(value) {
	...
	for (let i = 0; i < PARTS; i++) parts[PARTS - 1 - i] = fromHexReverseArray(sum, i * PARTS, PARTS);
	return parts;
}
var HighLow = class HighLow {
	...
	static fromBit(index) {
		...
		for (let i = 0; i < PARTS; i++) parts[PARTS - 1 - i] = i === offset ? 1 << index - offset * SMALL_INT : 0;
...
if (SUPPORTS_BIGINT && BigInt.prototype.toJSON == null) BigInt.prototype.toJSON = function() {
	return this.toString();
};
var HIGH_LOW_CACHE = {};
var convertToBigFlag = SUPPORTS_BIGINT ? function convertToBigFlagBigInt(value) {
	...
	if (value instanceof HighLow) return value;
	if (typeof value === "number") value = value.toString();
	if (HIGH_LOW_CACHE[value] != null) return HIGH_LOW_CACHE[value];
...
function flagOrMultiple(...flags) {
	let result = flags[0];
	for (let i = 1; i < flags.length; i++) result = flagOr(result, flags[i]);
	return result;
}
...
var BigFlagUtils = {
	...
	getFlag: SUPPORTS_BIGINT ? function getFlagBigInt(index) {
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/Constants.mjs
var RPCCloseCodes;
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/zodUtils.mjs
/**
...
function zodCoerceUnhandledValue(inputObject) {
	return preprocessType((arg) => {
		...
		if (arg != null && objectKey === void 0) return inputObject.UNHANDLED;
		return arg;
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/generated/schemas.mjs
/**
...
var GetActivityInstanceConnectedParticipantsResponseSchema = z.object({ participants: z.array(z.object({
	id: z.string(),
	username: z.string(),
	global_name: z.union([z.string(), z.null()]).optional(),
	discriminator: z.string(),
	...
	flags: z.number(),
	bot: z.boolean(),
	avatar_decoration_data: z.union([z.object({
		asset: z.string(),
...
var GetRelationshipsResponseSchema = z.object({ relationships: z.array(z.object({
	type: z.number(),
	user: z.object({
		id: z.string(),
		username: z.string(),
...
var GetUserResponseSchema = z.union([z.object({
	id: z.string(),
	username: z.string(),
	global_name: z.union([z.string(), z.null()]).optional(),
	discriminator: z.string(),
...
var GetQuestEnrollmentStatusResponseSchema = z.object({
	quest_id: z.string(),
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/schema/common.mjs
...
var Orientation$1 = zodCoerceUnhandledValue(OrientationTypeObject);
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/schema/events.mjs
var ERROR = "ERROR";
var Events;
(function(Events) {
	Events["READY"] = "READY";
...
var EventFrame = unionType([
	DispatchEventFrame,
	DispatchEventFrame.extend({ evt: stringType() }),
	ErrorEvent
]);
function parseEventPayload(data) {
	const event = data.evt;
	if (!(event in Events)) throw new Error(`Unrecognized event type ${data.evt}`);
	return EventSchema[event].payload.parse(data);
}
var EventSchema = {
	/**
	* @description
	...
	*
	*/
	[Events.READY]: { payload: DispatchEventFrame.extend({
	...
	[Events.VOICE_STATE_UPDATE]: {
		...
		subscribeArgs: objectType({ channel_id: stringType() })
	},
	...
	[Events.ACTIVITY_LAYOUT_MODE_UPDATE]: { payload: DispatchEventFrame.extend({
		evt: literalType(Events.ACTIVITY_LAYOUT_MODE_UPDATE),
		data: objectType({ layout_mode: zodCoerceUnhandledValue(LayoutModeTypeObject) })
	}) },
	[Events.ORIENTATION_UPDATE]: { payload: DispatchEventFrame.extend({
	...
	[Events.CURRENT_USER_UPDATE]: { payload: DispatchEventFrame.extend({
	...
	[Events.CURRENT_GUILD_MEMBER_UPDATE]: {
		...
		subscribeArgs: objectType({ guild_id: stringType() })
	},
	[Events.ENTITLEMENT_CREATE]: { payload: DispatchEventFrame.extend({
		evt: literalType(Events.ENTITLEMENT_CREATE),
		data: objectType({ entitlement: Entitlement })
	}) },
	[Events.THERMAL_STATE_UPDATE]: { payload: DispatchEventFrame.extend({
		evt: literalType(Events.THERMAL_STATE_UPDATE),
		data: objectType({ thermal_state: ThermalState })
	}) },
	[Events.ACTIVITY_INSTANCE_PARTICIPANTS_UPDATE]: { payload: DispatchEventFrame.extend({
		evt: literalType(Events.ACTIVITY_INSTANCE_PARTICIPANTS_UPDATE),
		data: objectType({ participants: GetActivityInstanceConnectedParticipantsResponseSchema.shape.participants })
	}) },
	[Events.RELATIONSHIP_UPDATE]: { payload: DispatchEventFrame.extend({
		evt: literalType(Events.RELATIONSHIP_UPDATE),
		data: Relationship
	}) },
	[Events.ACTIVITY_JOIN]: { payload: DispatchEventFrame.extend({
	...
	[Events.QUEST_ENROLLMENT_STATUS_UPDATE]: { payload: DispatchEventFrame.extend({
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/assertUnreachable.mjs
/**
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/schema/responses.mjs
...
var AuthorizeResponse = objectType({ code: stringType() });
var GetGuildsResponse = objectType({ guilds: arrayType(objectType({
	id: stringType(),
	name: stringType()
})) });
...
var GetChannelsResponse = objectType({ channels: arrayType(Channel) });
...
var SubscribeResponse = objectType({ evt: stringType() });
...
var SetConfigResponse = objectType({ use_interactive_pip: booleanType() });
var UserSettingsGetLocaleResponse = objectType({ locale: stringType() });
var EncourageHardwareAccelerationResponse = objectType({ enabled: booleanType() });
var GetChannelPermissionsResponse = objectType({ permissions: bigIntType().or(stringType()) });
...
*/
var GetPlatformBehaviorsResponse = objectType({ iosKeyboardResizesView: optionalType(booleanType()) });
...
function parseResponseData({ cmd, data }) {
	switch (cmd) {
		case Commands$1.AUTHORIZE: return AuthorizeResponse.parse(data);
		case Commands$1.CAPTURE_SHORTCUT: return CaptureShortcutResponse.parse(data);
		case Commands$1.ENCOURAGE_HW_ACCELERATION: return EncourageHardwareAccelerationResponse.parse(data);
		case Commands$1.GET_CHANNEL: return GetChannelResponse.parse(data);
		case Commands$1.GET_CHANNELS: return GetChannelsResponse.parse(data);
		case Commands$1.GET_CHANNEL_PERMISSIONS: return GetChannelPermissionsResponse.parse(data);
		case Commands$1.GET_GUILD: return GetGuildResponse.parse(data);
		case Commands$1.GET_GUILDS: return GetGuildsResponse.parse(data);
		case Commands$1.GET_PLATFORM_BEHAVIORS: return GetPlatformBehaviorsResponse.parse(data);
		case Commands$1.GET_CHANNEL: return GetChannelResponse.parse(data);
		case Commands$1.SELECT_TEXT_CHANNEL: return SelectTextChannelResponse.parse(data);
		case Commands$1.SELECT_VOICE_CHANNEL: return SelectVoiceChannelResponse.parse(data);
		case Commands$1.SET_ACTIVITY: return SetActivityResponse.parse(data);
		case Commands$1.GET_SKUS_EMBEDDED: return GetSkusResponse.parse(data);
		case Commands$1.GET_ENTITLEMENTS_EMBEDDED: return GetEntitlementsResponse.parse(data);
		case Commands$1.SET_CONFIG: return SetConfigResponse.parse(data);
		case Commands$1.START_PURCHASE: return StartPurchaseResponse.parse(data);
		case Commands$1.SUBSCRIBE:
		case Commands$1.UNSUBSCRIBE: return SubscribeResponse.parse(data);
		case Commands$1.USER_SETTINGS_GET_LOCALE: return UserSettingsGetLocaleResponse.parse(data);
		case Commands$1.OPEN_EXTERNAL_LINK: return OpenExternalLinkResponse.parse(data);
		...
		case Commands$1.GET_ENTITLEMENTS: return EmptyResponse.parse(data);
		...
		default: assertUnreachable(cmd, /* @__PURE__ */ new Error(`Unrecognized command ${cmd}`));
	}
}
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/schema/index.mjs
objectType({
	frame_id: stringType(),
...
function parseIncomingPayload(payload) {
	...
	if (incoming.evt != null) {
		if (incoming.evt === "ERROR") return ErrorEvent.parse(incoming);
		return parseEventPayload(EventFrame.parse(incoming));
	} else return parseResponsePayload(ResponseFrame.passthrough().parse(incoming));
}
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/commandFactory.mjs
function commandFactory(sendCommand, cmd, response, transferTransform = () => void 0) {
	...
	return async (args) => {
		...
		return payload.parse(reply).data;
	};
}
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/authorize.mjs
/**
...
*/
var authorize = (sendCommand) => commandFactory(sendCommand, Commands$1.AUTHORIZE, AuthorizeResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/captureLog.mjs
/**
*
*/
var captureLog = (sendCommand) => commandFactory(sendCommand, Commands$1.CAPTURE_LOG, EmptyResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/encourageHardwareAcceleration.mjs
/**
*
*/
var encourageHardwareAcceleration = (sendCommand) => commandFactory(sendCommand, Commands$1.ENCOURAGE_HW_ACCELERATION, EncourageHardwareAccelerationResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/getChannel.mjs
/**
*
* @description
...
* });
*/
var getChannel = (sendCommand) => commandFactory(sendCommand, Commands$1.GET_CHANNEL, GetChannelResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/getEntitlements.mjs
/**
*
*/
var getEntitlements = (sendCommand) => commandFactory(sendCommand, Commands$1.GET_ENTITLEMENTS_EMBEDDED, GetEntitlementsResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/getSkus.mjs
var getSkus = (sendCommand) => commandFactory(sendCommand, Commands$1.GET_SKUS_EMBEDDED, GetSkusResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/getChannelPermissions.mjs
/**
...
*/
var getChannelPermissions = (sendCommand) => commandFactory(sendCommand, Commands$1.GET_CHANNEL_PERMISSIONS, GetChannelPermissionsResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/getPlatformBehaviors.mjs
/**
...
*/
var getPlatformBehaviors = (sendCommand) => commandFactory(sendCommand, Commands$1.GET_PLATFORM_BEHAVIORS, GetPlatformBehaviorsResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/openExternalLink.mjs
/**
*
*/
var openExternalLink = (sendCommand) => commandFactory(sendCommand, Commands$1.OPEN_EXTERNAL_LINK, OpenExternalLinkResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/openInviteDialog.mjs
/**
...
*/
var openInviteDialog = (sendCommand) => commandFactory(sendCommand, Commands$1.OPEN_INVITE_DIALOG, EmptyResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/setActivity.mjs
Activity.pick({
	state: true,
	state_url: true,
	details: true,
...
* });
*/
var setActivity = (sendCommand) => commandFactory(sendCommand, Commands$1.SET_ACTIVITY, SetActivityResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/setConfig.mjs
/**
*
*/
var setConfig = (sendCommand) => commandFactory(sendCommand, Commands$1.SET_CONFIG, SetConfigResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/compatCommandFactory.mjs
/**
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/setOrientationLockState.mjs
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/startPurchase.mjs
/**
*
*/
var startPurchase = (sendCommand) => commandFactory(sendCommand, Commands$1.START_PURCHASE, StartPurchaseResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/userSettingsGetLocale.mjs
/**
*
*/
var userSettingsGetLocale = (sendCommand) => commandFactory(sendCommand, Commands$1.USER_SETTINGS_GET_LOCALE, UserSettingsGetLocaleResponse);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/authenticate.mjs
/**
* Authenticate Activity
*/
var authenticate = schemaCommandFactory(Command.AUTHENTICATE);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/getActivityInstanceConnectedParticipants.mjs
var getActivityInstanceConnectedParticipants = schemaCommandFactory(Command.GET_ACTIVITY_INSTANCE_CONNECTED_PARTICIPANTS);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/getQuestEnrollmentStatus.mjs
var getQuestEnrollmentStatus = schemaCommandFactory(Command.GET_QUEST_ENROLLMENT_STATUS);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/getRelationships.mjs
var getRelationships = schemaCommandFactory(Command.GET_RELATIONSHIPS);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/getUser.mjs
var getUser = schemaCommandFactory(Command.GET_USER);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/initiateImageUpload.mjs
/**
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/inviteUserEmbedded.mjs
var inviteUserEmbedded = schemaCommandFactory(Command.INVITE_USER_EMBEDDED);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/openShareMomentDialog.mjs
/**
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/questStartTimer.mjs
var questStartTimer = schemaCommandFactory(Command.QUEST_START_TIMER);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/shareInteraction.mjs
var shareInteraction = schemaCommandFactory(Command.SHARE_INTERACTION);
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/shareLink.mjs
/**
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/commands/index.mjs
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/error.mjs
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/getDefaultSdkConfiguration.mjs
function getDefaultSdkConfiguration() {
	return { disableConsoleLogOverride: false };
}
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/console.mjs
var consoleLevels = [
	"log",
	"warn",
	"debug",
...
function wrapConsoleMethod(console, level, callback) {
	...
	console[level] = function() {
		...
		callback(level, "" + args.join(" "));
		_consoleMethod.apply(_console, args);
	};
}
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/package.json.mjs
var version = "2.4.1";
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/native.mjs
var native = { randomUUID: typeof crypto !== "undefined" && crypto.randomUUID && crypto.randomUUID.bind(crypto) };
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/rng.mjs
var getRandomValues;
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/stringify.mjs
var byteToHex = [];
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/v4.mjs
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/Discord.mjs
var Opcodes;
(function(Opcodes) {
...
var DiscordSDK = class {
	getTransfer(payload) {
		...
		switch (payload.cmd) {
			case Commands$1.SUBSCRIBE:
			case Commands$1.UNSUBSCRIBE: return;
			default: return (_a = payload.transfer) !== null && _a !== void 0 ? _a : void 0;
		}
	}
	constructor(clientId, configuration) {
		...
		this.sendCommand = (payload) => {
			...
			const nonce = v4();
			(_a = this.source) === null || _a === void 0 || _a.postMessage([Opcodes.FRAME, Object.assign(Object.assign({}, payload), { nonce })], this.sourceOrigin, this.getTransfer(payload));
		...
		*/
		this.handleMessage = (event) => {
			...
			switch (opcode) {
				case Opcodes.HELLO: return;
				case Opcodes.CLOSE: return this.handleClose(data);
				case Opcodes.HANDSHAKE: return this.handleHandshake();
				case Opcodes.FRAME: return this.handleFrame(data);
		...
		else if (platform !== Platform.DESKTOP && platform !== Platform.MOBILE) throw new Error(`Invalid query param "platform" of "${platform}". Valid values are "${Platform.DESKTOP}" or "${Platform.MOBILE}"`);
	...
	close(code, message) {
		...
		const nonce = v4();
		(_a = this.source) === null || _a === void 0 || _a.postMessage([Opcodes.CLOSE, {
			code,
			message,
			nonce
		}], this.sourceOrigin);
	...
	async subscribe(event, listener, ...rest) {
		...
		if (Object.values(Events).includes(event) && event !== Events.READY && listenerCount === 0) await this.sendCommand({
	...
	async unsubscribe(event, listener, ...rest) {
		...
		if (event !== Events.READY && this.eventBus.listenerCount(event) === 1) await this.sendCommand({
	...
	handshake() {
		...
		if (this.platform === Platform.DESKTOP || majorMobileVersion >= 250) handshakePayload["sdk_version"] = this.sdkVersion;
		(_a = this.source) === null || _a === void 0 || _a.postMessage([Opcodes.HANDSHAKE, handshakePayload], this.sourceOrigin);
	}
	addOnReadyListener() {
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/PermissionUtils.mjs
function can(permission, permissions) {
	return BigFlagUtils.has(BigFlagUtils.deserialize(permissions), permission);
}
var PermissionUtils = { can };
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/lib/decimal.js-light/decimal.mjs
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/PriceConstants.mjs
var CurrencyCodes;
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/PriceUtils.mjs
function formatPrice(price, locale = "en-US") {
	const { amount, currency } = price;
	return Intl.NumberFormat(locale, {
		style: "currency",
		currency
	}).format(convertToMajorCurrencyUnits(amount, currency));
}
function convertToMajorCurrencyUnits(minorUnitValue, currency) {
	...
	return new Decimal$1(minorUnitValue).dividedBy(10 ** exponent).toNumber();
}
var PriceUtils = { formatPrice };
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/_virtual/index3.mjs
var lodash_transform = { exports: {} };
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/lib/lodash.transform/index.mjs
/**
	...
	(function(module, exports) {
		...
		*/
		function transform(object, iteratee, accumulator) {
			...
			if (accumulator == null) if (isArr || isObject(object)) {
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/_virtual/index2.mjs
var transform = /* @__PURE__ */ getDefaultExportFromCjs(requireLodash_transform());
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/mock.mjs
...
var commandsMockDefault = {
	...
	getPlatformBehaviors: () => Promise.resolve({ iosKeyboardResizesView: true }),
	...
	shareLink: () => Promise.resolve({
		success: false,
		didSendMessage: false,
		didCopyLink: false
	}),
	initiateImageUpload: () => Promise.resolve({ image_url: "https://assets-global.website-files.com/6257adef93867e50d84d30e2/636e0b52aa9e99b832574a53_full_logo_blurple_RGB.png" }),
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/lib/tslib/tslib.es6.mjs
/******************************************************************************
Copyright (c) Microsoft Corporation.
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/url.mjs
/**
...
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/utils/patchUrlMappings.mjs
function patchUrlMappings(mappings, { patchFetch = true, patchWebSocket = true, patchXhr = true, patchSrcAttributes = false } = {}) {
	...
	if (patchFetch) {
		...
		window.fetch = function(input, init) {
			if (input instanceof Request) {
				const newUrl = attemptRemap({
					url: absoluteURL(input.url),
					mappings
				});
				const newInit = __rest(init !== null && init !== void 0 ? init : {}, ["url"]);
				...
				return new Promise((resolve, reject) => {
					try {
						input.blob().then((blob) => {
							if (input.method.toUpperCase() !== "HEAD" && input.method.toUpperCase() !== "GET" && blob.size > 0) newInit.body = blob;
	...
	if (patchSrcAttributes) {
		const callback = function(mutationsList) {
			for (const mutation of mutationsList) if (mutation.type === "attributes" && mutation.attributeName === "src") attemptSetNodeSrc(mutation.target, mappings);
			else if (mutation.type === "childList") mutation.addedNodes.forEach((node) => {
				attemptSetNodeSrc(node, mappings);
				recursivelyRemapChildNodes(node, mappings);
			});
		};
		new MutationObserver(callback).observe(window.document, {
			attributeFilter: ["src"],
			childList: true,
			subtree: true
		});
...
function recursivelyRemapChildNodes(node, mappings) {
	if (node.hasChildNodes()) node.childNodes.forEach((child) => {
...
function attemptSetNodeSrc(node, mappings) {
	if (node instanceof HTMLElement && node.hasAttribute("src")) {
		...
		if (node.tagName.toLowerCase() === "script") attemptRecreateScriptNode(node, {
			url,
			mappings
		});
		else {
			const newSrc = attemptRemap({
				url,
				mappings
			}).toString();
...
function attemptRecreateScriptNode(node, { url, mappings }) {
	...
	if (url.toString() !== newUrl.toString()) {
		...
		for (const attr of node.attributes) newNode.setAttribute(attr.name, attr.value);
		newNode.setAttribute("src", attemptRemap({
			url,
			mappings
		}).toString());
		node.after(newNode);
...
function attemptRemap({ url, mappings }) {
	...
	for (const mapping of mappings) {
		...
		if (mapped != null && (mapped === null || mapped === void 0 ? void 0 : mapped.toString()) !== url.toString()) return mapped;
	}
	return newURL;
}
//#endregion
//#region ../../../../../node_modules/@discord/embedded-app-sdk/output/index.mjs
var { Commands } = common_exports;
//#endregion
export { Commands, common_exports as Common, DiscordSDK, DiscordSDKMock, Events, Orientation, PermissionUtils, Permissions, Platform, PriceUtils, RPCCloseCodes, RPCErrorCodes, responses_exports as Responses, attemptRemap, patchUrlMappings };
